...
public class Demo_SynthGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "Demo Synth"; } }
    public override string Description    { get { return "Demo Synth"; } }
    public override string Vendor         { get { return "Playful Tones"; } }

    //==============================================================================
    [DllImport("Demo Synth")] static extern System.IntPtr getRenderCallback();

    [DllImport("Demo Synth")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("Demo Synth")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("Demo Synth")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("Demo Synth")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("Demo Synth")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("Demo Synth")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
